...
####################################################
## 3. Tipos de datos primitivos y operadores.
####################################################
...
####################################################
## 4. Estructura de datos("Variables y Colecciones")
####################################################
...
#"""Python provee el tipo de dato set (conjunto) el cual se compone de una lista
#   no ordenada de datos en la cual no hay ningún dato repetido.
#    La forma de creación de un conjunto en python es la siguiente:"""
...
$ virtualenv2 app_amae
#Lo que crea el directorio mi_proyecto/ con la siguiente estructura.
mi_proyecto/
    bin/
    include/
    lib/
#Levantar un entorno virtualenv2
$ cd mi_proyecto
$ source bin/activate
(amae_env)$
#Instalar packages
(amae_env)$ pip install django
####################################################
## 6. EJERCICIOS
####################################################

#   Exercice 01:sc_AMAE.PY
# -*- coding: utf8 -*-
print "¡Hola mundo!"

#   Exercice 02:sc_PRIMOS.PY
"""Encontrar los primeros M números enteros positivos divisibles entre 7 ó 13.
"""
...
# Exercise 06
"""
Leer N números enteros DISTINTOS desde el teclado.
"""
# Exercise 08
"""
Implementar una función que según una cadena de texto que represente
la operación devuelva otra función que implemente dicha operación
...
#EXercise 09
"""
Invocación programática de funciones con *args y **kwargs al momento
